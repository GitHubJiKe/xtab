    ...
    <div className="App p-4">
      ...
      <ResizablePanelGroup direction="horizontal">
        <ResizablePanel defaultSize={24} minSize={24}>
          ...
          <div
            className="flex gap-4 mb-4 w-auto flex-wrap overflow-y-auto"
            style={{ minWidth: 220 }}
          >
            {sites.map((site) => (
              <Card
        ...
        <ResizablePanel defaultSize={30} minSize={20}>
          ...
          <div className="flex gap-4 mb-4 ml-4 w-auto flex-wrap overflow-y-auto">
        ...
        <ResizableHandle withHandle />
        <ResizablePanel defaultSize={46} minSize={40}>
